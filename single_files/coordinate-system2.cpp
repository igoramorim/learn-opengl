...
int main()
{
	...
	*/
	...
	glm::vec4 cubePositions[] = {
		...
		glm::vec4( 0.0f,  0.0f,  0.0f,  360.0f),
		glm::vec4( 2.0f,  2.0f, -3.0f,  180.0f),
		glm::vec4(-2.0f,  1.0f, -2.0f,  90.0f),
	};
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		viewMatrix = glm::translate(viewMatrix, glm::vec3(0.0f, -1.0f, -8.0f));
		//viewMatrix = glm::translate(viewMatrix, glm::vec3(1.0f + sin(time), 0.0f, -1.0f + cos(time)));
		viewMatrix = glm::rotate(viewMatrix, glm::radians(sin(time) * 30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		for (unsigned int i = 0; i < 3; i++)
		{
			...
			modelMatrix = glm::translate(modelMatrix, glm::vec3(cubePositions[i].x * sin(time), cubePositions[i].y * sin(time), cubePositions[i].z * cos(time)));
			modelMatrix = glm::rotate(modelMatrix, glm::radians(cubePositions[i].w) * time, glm::vec3(0.0f, 1.0f, 0.0f));
