...
public:
    ...
    // returns the view matrix calculated manually
    glm::mat4 getViewMatrixCustomCalculation()
    {
    ...
    void processKeyboard(Camera_Movement direction, float deltaTime)
    {
        ...
        // Position.y = 0.0f; // remove the 'fly' style from the camera keeping it on the same y position
    }
